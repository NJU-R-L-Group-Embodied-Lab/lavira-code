...
class FusionMapPolicy(nn.Module):
    ...
    def _get_action(self, 
        ...
        stg_x, stg_y, stop = planner.get_short_term_goal(position, None)
        ...
        # print('[DBG]Agent position:', position)
        # print('[DBG]waypoint:', waypoint)
        # print('[DBG]sub waypoint:',sub_waypoint)
        # print('[DBG]waypoint_vector:', waypoint_vector)
        ...
        if stop and self.fixed_destination is not None:
            ...
            # print('[DBG]relative_angle:', relative_angle)
